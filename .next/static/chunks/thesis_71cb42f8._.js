...
function TransactionTable(param) {
    ...
    const handleSave = (id)=>{
        ...
        onEditTransaction === null || onEditTransaction === void 0 ? void 0 : onEditTransaction(updatedTransaction, id);
        // Recalculate running balances for all rows
        ...
        const updated = transactions.map((t)=>{
            ...
            runningBalance = runningBalance + (newT.deposit || 0) - (newT.withdrawal || 0);
            return {
                ...newT,
...
_s(TransactionTable, "yC/NjskkZivxfJu+NV65icbUtz4=");
_c = TransactionTable;
var _c;
