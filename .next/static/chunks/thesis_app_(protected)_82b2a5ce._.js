...
function TransactionTable(param) {
    let { transactions = [], loading, onEditTransaction, onDeleteTransaction, hideActions = false } = param;
    _s();
...
function TransactionsPage() {
    ...
    const handleExportExcel = async ()=>{
        try {
            ...
            let query = __TURBOPACK__imported__module__$5b$project$5d2f$thesis$2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("transactions").select("*").gte("date", "".concat(selectedYear, "-01-01")).lte("date", "".concat(selectedYear, "-12-31"));
            if (exportType === "income") query = query.gt("deposit", 0);
            if (exportType === "expense") query = query.gt("withdrawal", 0);
            const { data, error } = await query;
            if (error) throw error;
            if (!data || data.length === 0) {
                alert("No ".concat(exportType, " data for ").concat(selectedYear));
                return;
            }
            const formatted = data.map((t)=>{
                var _t_deposit, _t_withdrawal, _t_balance;
                return {
                    Date: t.date,
                    Description: t.description || "",
                    Income: (_t_deposit = t.deposit) !== null && _t_deposit !== void 0 ? _t_deposit : 0,
                    Expenses: (_t_withdrawal = t.withdrawal) !== null && _t_withdrawal !== void 0 ? _t_withdrawal : 0,
                    Balance: (_t_balance = t.balance) !== null && _t_balance !== void 0 ? _t_balance : 0
                };
            });
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$thesis$2f$node_modules$2f$xlsx$2f$xlsx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["writeFile"](workbook, "transactions_".concat(exportType, "_").concat(selectedYear, ".xlsx"));
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$thesis$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$thesis$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$thesis$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                            ...
                                            className: "px-4 py-2 rounded-lg font-medium text-white shadow\n                ".concat(exportLoading ? "bg-blue-400 cursor-not-allowed" : "bg-blue-600 hover:bg-blue-700", "\n              "),
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$thesis$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    onClick: ()=>{
                                        const url = "/transaction/print?year=".concat(selectedYear, "&type=").concat(exportType);
