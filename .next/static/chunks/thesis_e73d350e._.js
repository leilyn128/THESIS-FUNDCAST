...
function TransactionsPage() {
    ...
    const fetchCashflow = async ()=>{
        setLoading(true);
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$thesis$2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("transactions") // 👈 change this if your table has a different name
        .select("*").order("date", {
            ascending: true
        });
        if (error) {
