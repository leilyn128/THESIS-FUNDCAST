...
function useBreakdownData() {
    ...
    async function fetchBreakdownData() {
        const { data, error } = await supabase.from("barangay_budget_breakdown").select("year, category, subcategory, description, amount");
        if (error) return console.error(error);
        const grouped = {};
        data.forEach((row)=>{
            var _row_category;
...
function PieGroup(param) {
    ...
    const currency = (v)=>new Intl.NumberFormat("en-PH", {
            style: "currency",
            currency: "PHP"
        }).format(v);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$thesis$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
(()=>{
    const e = new Error("Cannot find module './components/budgetUploaderudgetUploader'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
...
//# sourceMappingURL=thesis_app_%28protected%29_transactions_9c2f4a44._.js.map